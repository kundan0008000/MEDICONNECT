    ...
    <div>
      ...
      {selectedDoctor && (
        <div className="bg-white rounded-xl shadow p-6 mt-6">
          <div className="text-xl font-semibold mb-4">Book Appointment with {mockDoctors.find(d => d.id === selectedDoctor).name}</div>
          <div className="mb-4">
            ...
            >
              ...
              {mockDoctors.find(d => d.id === selectedDoctor).available.map(date => (
